...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MetaTable'
        db.create_table('ta_metatable', (
            ('metakey', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('metatype', self.gf('django.db.models.fields.IntegerField')()),
            ('string_field', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('int_field', self.gf('django.db.models.fields.IntegerField')()),
            ('float_field', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('ta', ['MetaTable'])


    def backwards(self, orm):
        
        # Deleting model 'MetaTable'
        db.delete_table('ta_metatable')
    ...
    models = {
        ...
        'ta.metatable': {
            ...
            'float_field': ('django.db.models.fields.FloatField', [], {}),
            ...
            'string_field': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'ta.price': {

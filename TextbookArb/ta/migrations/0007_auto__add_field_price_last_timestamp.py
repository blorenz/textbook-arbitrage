...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.last_timestamp'
        db.add_column('ta_price', 'last_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 10, 3), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Price.last_timestamp'
        db.delete_column('ta_price', 'last_timestamp')

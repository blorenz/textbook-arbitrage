...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetaTable.metatype'
        db.alter_column('ta_metatable', 'metatype', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'MetaTable.metatype'
        db.alter_column('ta_metatable', 'metatype', self.gf('django.db.models.fields.IntegerField')())

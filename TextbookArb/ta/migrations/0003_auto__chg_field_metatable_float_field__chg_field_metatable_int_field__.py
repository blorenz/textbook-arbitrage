...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetaTable.float_field'
        db.alter_column('ta_metatable', 'float_field', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'MetaTable.int_field'
        db.alter_column('ta_metatable', 'int_field', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'MetaTable.string_field'
        db.alter_column('ta_metatable', 'string_field', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'MetaTable.float_field'
        db.alter_column('ta_metatable', 'float_field', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'MetaTable.int_field'
        db.alter_column('ta_metatable', 'int_field', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'MetaTable.string_field'
        db.alter_column('ta_metatable', 'string_field', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
    ...
    models = {
        ...
        'ta.metatable': {
            ...
            'metatype': ('django.db.models.fields.IntegerField', [], {}),

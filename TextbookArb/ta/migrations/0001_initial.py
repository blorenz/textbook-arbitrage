...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ta_price', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buy', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2)),
            ('sell', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2)),
        ...
        db.create_table('ta_amazon', (
            ...
            ('price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ta.Price'], null=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
    ...
    models = {
        'ta.amazon': {
            ...
            'price': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ta.Price']", 'null': 'True'}),
